    ...
    if ( have_posts() )
    {
        while ( have_posts() )
        {
            ...
            if(is_user_logged_in()){
                require_once (get_template_directory(). '/templates/tamplate-single-serija-loged.php');
            }else{
                require_once (get_template_directory(). '/templates/tamplate-single-serija-logedout.php');
            } 
        }
    }
