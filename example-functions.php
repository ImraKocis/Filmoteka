 ...
 *
 * Be sure to replace all instances of 'filmoteka_' with your project's prefix.
 ...
 */
function filmoteka_show_if_front_page( $cmb ) {
 ...
 * @return bool              True if metabox should show
 */
function filmoteka_hide_if_no_cats( $field ) {
 ...
 */
function filmoteka_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function filmoteka_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field $field      Field object.
 */
function filmoteka_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'filmoteka_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function filmoteka_register_demo_metabox() {
	/**
	 * Sample metabox to demonstrate each field type included
	 */
	$cmb_demo = new_cmb2_box( array(
		'id'            => 'filmoteka_demo_metabox',
		'title'         => esc_html__( 'Test Metabox', 'cmb2' ),
		'object_types'  => array( 'page' ), // Post type
		// 'show_on_cb' => 'filmoteka_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 'filmoteka_add_some_classes', // Add classes through a callback.
	...
	$cmb_demo->add_field( array(
		...
		'id'         => 'filmoteka_demo_text',
		'type'       => 'text',
		'show_on_cb' => 'filmoteka_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'filmoteka_display_text_small_column', // Output the display of the column values through a callback.
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Medium', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'filmoteka_demo_textmedium',
		'type' => 'text_medium',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'filmoteka_demo_render_row_cb',
		'type' => 'text',
		'render_row_cb' => 'filmoteka_render_row_cb',
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Website URL', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'filmoteka_demo_url',
		'type' => 'text_url',
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'filmoteka_demo_textdate_timestamp',
		'type' => 'text_date_timestamp',
		// 'timezone_meta_key' => 'filmoteka_demo_timezone', // Optionally make this field honor the timezone selected in the select_timezone specified above
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date/Time Picker Combo (UNIX timestamp)', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'filmoteka_demo_datetime_timestamp',
	...
	// 	'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
	// 	'id'   => 'filmoteka_demo_datetime_timestamp_timezone',
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'filmoteka_demo_textareasmall',
		'type' => 'textarea_small',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'filmoteka_demo_textarea_code',
		'type' => 'textarea_code',
		// 'attributes' => array(
	...
	$cmb_demo->add_field( array(
		...
		'desc'             => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'               => 'filmoteka_demo_radio_inline',
		'type'             => 'radio_inline',
	...
	$cmb_demo->add_field( array(
		...
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'filmoteka_demo_text_taxonomy_radio',
	...
	$cmb_demo->add_field( array(
		...
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'filmoteka_demo_taxonomy_select',
	...
	$cmb_demo->add_field( array(
		...
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'filmoteka_demo_multitaxonomy',
	...
	$cmb_demo->add_field( array(
		...
		'desc'    => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'      => 'filmoteka_demo_multicheckbox',
		'type'    => 'multicheck',
	...
	$cmb_demo->add_field( array(
		...
		'id'   => 'filmoteka_demo_embed',
		'type' => 'oembed',
	) );

	$cmb_demo->add_field( array(
		'name'         => 'Testing Field Parameters',
		'id'           => 'filmoteka_demo_parameters',
		'type'         => 'text',
		'before_row'   => 'filmoteka_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'filmoteka_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function filmoteka_register_about_page_metabox() {

	/**
	 * Metabox to be displayed on a single page ID
	 */
	$cmb_about_page = new_cmb2_box( array(
		'id'           => 'filmoteka_about_metabox',
	...
	$cmb_about_page->add_field( array(
		'name' => esc_html__( 'Test Text', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'filmoteka_about_text',
		'type' => 'text',
	) );

}

add_action( 'cmb2_admin_init', 'filmoteka_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function filmoteka_register_repeatable_group_field_metabox() {

	/**
	 * Repeatable Field Groups
	 */
	$cmb_group = new_cmb2_box( array(
		'id'           => 'filmoteka_group_metabox',
		'title'        => esc_html__( 'Repeating Field Group', 'cmb2' ),
		'object_types' => array( 'page' ),
	) );

	// $group_field_id is the field id string, so in this case: 'filmoteka_group_demo'
	$group_field_id = $cmb_group->add_field( array(
		'id'          => 'filmoteka_group_demo',
		'type'        => 'group',
...
add_action( 'cmb2_admin_init', 'filmoteka_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function filmoteka_register_user_profile_metabox() {

	/**
	 * Metabox for the user profile screen
	 */
	$cmb_user = new_cmb2_box( array(
		'id'               => 'filmoteka_user_edit',
	...
	$cmb_user->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'filmoteka_user_googleplusurl',
		'type' => 'text_url',
	) );
	...
	$cmb_user->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'filmoteka_user_user_text_field',
		'type' => 'text',
	) );

}

add_action( 'cmb2_admin_init', 'filmoteka_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function filmoteka_register_taxonomy_metabox() {

	/**
	 * Metabox to add fields to categories and tags
	 */
	$cmb_term = new_cmb2_box( array(
		'id'               => 'filmoteka_term_edit',
	...
	$cmb_term->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'filmoteka_term_term_text_field',
		'type' => 'text',
	) );

}

add_action( 'cmb2_admin_init', 'filmoteka_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function filmoteka_register_theme_options_metabox() {

	/**
	 * Registers options page menu item and form.
	 */
	$cmb_options = new_cmb2_box( array(
		'id'           => 'filmoteka_theme_options_page',
		...
		'option_key'      => 'filmoteka_theme_options', // The option key and admin menu page slug.
		...
		// 'message_cb'              => 'filmoteka_options_page_message_callback',
 ...
 * }
 */
function filmoteka_options_page_message_callback( $cmb, $args ) {
 ...
 */
function filmoteka_limit_rest_view_to_logged_in_users( $is_allowed, $cmb_controller ) {
...
add_action( 'cmb2_init', 'filmoteka_register_rest_api_box' );
/**
 ...
 */
function filmoteka_register_rest_api_box() {
	$cmb_rest = new_cmb2_box( array(
		'id'            => 'filmoteka_rest_metabox',
		...
		// 'get_box_permissions_check_cb' => 'filmoteka_limit_rest_view_to_logged_in_users',
	) );
	...
	$cmb_rest->add_field( array(
		...
		'id'         => 'filmoteka_rest_editable_text',
		'type'       => 'text',
